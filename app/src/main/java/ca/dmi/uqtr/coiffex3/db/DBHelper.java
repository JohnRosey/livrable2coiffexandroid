package ca.dmi.uqtr.coiffex3.db;
...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        db.execSQL(" CREATE TABLE " + USER_TABLE +
                "(" + COLUMN_NAME + " TEXT, "+ COLUMN_MAIL + " TEXT, " + COLUMN_NUMBER + " TEXT, "
    ...
    public void addUser(String name, String username, String password, String cnfrmpassword, String mail, String number) {
